...
DEFAULT_COUNTRY = os.environ.get("DEFAULT_COUNTRY", "ZM")
DEFAULT_CURRENCY = os.environ.get("DEFAULT_CURRENCY", "ZMK ")
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,0.0.0.0,104.156.250.24"))
